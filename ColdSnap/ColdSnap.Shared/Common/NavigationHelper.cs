...
namespace ColdSnap.Common
{
	public static class NavigationExtensions
	{
		public static void Navigate(this Window window, Type sourcePageType, object parameter = null)
		{
			(window.Content as Frame).Navigate(sourcePageType, parameter);
		}
	}
